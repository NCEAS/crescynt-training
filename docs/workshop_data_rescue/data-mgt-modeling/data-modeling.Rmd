...
*=> Easier to conduct your Analysis!!*
...
__Observations__. A better way to model data is to organize the observations about each type of entity
in its own table.  This results in:
...
of the rows from the left table with their matching rows from the right table: 
this is called an *INNER JOIN*.  Other types of join are possible as well, including

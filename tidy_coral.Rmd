...
Let's go back up to the setup and add `stringr` to the setup chunk and run it. 
```{r}
benthic <- benthic %>%
...
names(buoy) <- str_c(names(buoy),                  ## first thing to combine
                  buoy %>% filter(`#YY` == "#yr"), ## second thing
                  sep = "_")                       ## separate by this
...
Let's say we want to compare these temperatures to the benthic species from above.
